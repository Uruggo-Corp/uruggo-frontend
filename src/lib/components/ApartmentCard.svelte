...
<div class="overflow-hidden rounded-[5px] border border-dark">
	<div>
		<img
			src="/house.png"
			class="w-full hover:scale-105 transition-all duration-300 hover:blur-none blur-[1px]"
			alt="Apartment placeholder"
		/>
	</div>

	<div class="p-[16px] space-y-[4px]">
		<h3 class="text-xl">Furnished 2 Bedroom Flat</h3>
		<div class="flex space-x-[4px] items-center">
			...
			<span class="text-sm"> Yaba, Lagos </span>
		</div>
		<div class="flex justify-between items-end">
			<p class="text-dark font-bold">250,000/yr</p>
			{#if !inRecommended}
				<a href="/apartments/slug" class="px-5 py-2 bg-[#DCE4EF] text-lg">View</a>
			{/if}
		</div>
	</div>
</div>
